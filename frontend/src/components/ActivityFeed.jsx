    ...
    <Card className='border-outline-variant'>
      ...
      <CardContent className='flex flex-col gap-4'>
        {isLoading ? (
          ...
          <div className='flex h-48 flex-col items-center justify-center rounded-lg border-2 border-dashed border-outline-variant bg-surface text-center'>
            <Icon
            ...
            <p className='mt-1 max-w-xs text-sm text-on-surface-variant/70'>
              Create a tournament or log a match to see activity here.
            </p>
          </div>
        ) : (
          activity.map((item) => (
