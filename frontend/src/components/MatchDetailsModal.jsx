...
import { Loader2, Trophy, Users, ArrowLeft, ChevronLeft } from 'lucide-react';
...
const MatchDetailsFullPage = ({ matchId, onBack }) => {
  ...
  return (
    ...
    >
      ...
      <div className='sticky top-0 z-50 flex h-20 items-center justify-between border-b border-white/20 bg-white/80 px-4 backdrop-blur-md supports-[backdrop-filter]:bg-white/60 sm:px-6 lg:px-8'>
...
const MatchHeader = ({ match }) => {
  ...
  return (
    <div className='relative overflow-hidden bg-white pb-6 pt-8 text-gray-900 shadow-sm'>
      {/* Subtle colorful glow based on teams */}
      <div className='absolute inset-0 z-0 bg-gradient-to-b from-gray-50/50 to-transparent' />

      <div className='relative z-10 mx-auto flex max-w-4xl items-center justify-between px-6'>
        {/* Team 1 */}
        <TeamDisplay
          team={match.team1}
          score={match.team1_score}
          isWinner={isCompleted && match.team1_score > match.team2_score}
          align='left'
        />
        ...
        <div className='flex flex-col items-center gap-3'>
          {isLive ? (
            <motion.div
              ...
              className='flex items-center gap-1.5 rounded-full bg-red-50 px-3 py-1 text-xs font-bold text-red-600 ring-1 ring-red-100'
            >
            ...
            <div className='flex h-8 items-center justify-center rounded-full bg-gray-100 px-4 text-xs font-bold tracking-wide text-gray-500'>
        ...
        <TeamDisplay
          ...
          isWinner={isCompleted && match.team2_score > match.team1_score}
          align='right'
        />
      </div>
    </div>
